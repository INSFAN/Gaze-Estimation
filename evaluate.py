...
parser.add_argument('--label_data_dir', type=str, default='dataset/VOCdevkit/VOC2012/SegmentationClassAug/SegmentationClassAug',
...
parser.add_argument('--model_dir', type=str, default='./model/trained_model',
